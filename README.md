...
[![Twitter Follow](https://img.shields.io/twitter/follow/vishalmandal713_?style=social)](https://twitter.com/intent/follow?screen_name=vishalmandal713_)
  ...
  <a href="https://vishalmandal713.github.io/foodie/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/vishalmandal713/foodie.git
```

Windows:

```bash
git clone https://github.com/vishalmandal713/foodie.git
```
